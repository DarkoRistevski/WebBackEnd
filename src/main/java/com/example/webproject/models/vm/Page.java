package com.example.webproject.models.vm;

import com.example.webproject.models.exceptions.InvalidPageException;
...
public class Page<T> {
    ...
    public static <T> Page<T> slice(List<T> content, int page, int pageSize){
        ...
        if(pageStart < 0 || pageStart > content.size() || pageEnd < 0){
